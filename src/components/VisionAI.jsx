        ...
        if (onNavigate) {
            onNavigate({
                ...
                detailed_steps: [
                    ...
                    { type: 'transit', icon: '🚍', text: lang === 'HI' ? "धौला कुआं की ओर बस 764 पर चढ़ें" : "Board Bus 764 towards Dhaula Kuan", distance: "Board", pathType: "Driving Road" },
                    { type: 'walk', icon: '🚶', text: lang === 'HI' ? "धौला कुआं पर उतरें" : "Alight at Dhaula Kuan", distance: "0m", pathType: "Walking Path" },
                    { type: 'arrive', icon: '📍', text: lang === 'HI' ? "गंतव्य की ओर थोड़ा चलें" : "Walk short distance to Destination", distance: "50m", pathType: "Destination" }
                ],
                route_geojson: [
